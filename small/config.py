...
class CompressionConfig:
    ...
    subsumption_min_independent: int = 2  # Min independent occurrences to keep subsumed pattern
    ...
    adaptive_system_fraction: float = 0.1  # Heuristic: fraction assumed to be system context
    
    # Quality prediction
    enable_quality_prediction: bool = False
    quality_task_type: str = "general"  # Task type for quality prediction
    max_predicted_degradation: float = 0.05  # Skip compression if predicted degradation exceeds
